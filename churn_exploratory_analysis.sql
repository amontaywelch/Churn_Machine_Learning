...
SELECT 
  CASE 
    WHEN time_since_last_purchase < 10 THEN '0–9 days'
    WHEN time_since_last_purchase BETWEEN 10 AND 30 THEN '10–30 days'
    WHEN time_since_last_purchase BETWEEN 31 AND 60 THEN '31–60 days'
    ELSE '60+ days'
...
-- adding signup_date for time series visuals in Looker
